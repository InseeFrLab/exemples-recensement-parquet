...
Ces fichiers peuvent être téléchargés et dézippés manuellement.
...
dans `Python` ou `R`. A la fin de ce _post_,
plus de détails justifiant ce choix
techniques sont disponibles.

::: {.callout-danger collapse="true"}
